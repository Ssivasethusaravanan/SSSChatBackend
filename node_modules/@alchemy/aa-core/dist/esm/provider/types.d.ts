...
import type { BatchUserOperationCallData, UserOperationCallData, UserOperationOverrides, UserOperationReceipt, UserOperationRequest, UserOperationResponse, UserOperationStruct } from "../types.js";
...
export type AccountMiddlewareFn = (struct: Deferrable<UserOperationStruct>) => Promise<Deferrable<UserOperationStruct>>;
export type AccountMiddlewareOverrideFn<Req extends keyof UserOperationStruct = never, Opt extends keyof UserOperationStruct = never> = (struct: Deferrable<UserOperationStruct>) => Promise<WithRequired<UserOperationStruct, Req> & WithOptional<UserOperationStruct, Opt>>;
