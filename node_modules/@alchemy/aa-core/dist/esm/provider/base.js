    ...
    constructor(config) {
        ...
        Object.defineProperty(this, "_runMiddlewareStack", {
            ...
            value: async (uo, overrides) => {
                const result = await asyncPipe(this.dummyPaymasterDataMiddleware, this.feeDataGetter, this.gasEstimator, async (struct) => ({ ...struct, ...overrides }), this.customMiddleware, overrides?.paymasterAndData
                    ? noOpMiddleware
        ...
        Object.defineProperty(this, "feeDataGetter", {
            ...
            value: async (struct) => {
                ...
                const maxPriorityFeePerGasBid = bigIntMax(bigIntPercent(maxPriorityFeePerGas, BigInt(100 + this.maxPriorityFeePerGasEstimateBuffer)), this.minPriorityFeePerBid);
