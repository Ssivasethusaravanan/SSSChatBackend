...
class SmartAccountProvider extends eventemitter3_1.default {
    constructor(config) {
        ...
        Object.defineProperty(this, "maxPriorityFeePerGasEstimateBuffer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "buildUserOperationFromTxs", {
            ...
            value: (requests, overrides) => {
                ...
                const maxFeePerGas = (0, index_js_1.bigIntMax)(...requests
                    .filter((x) => x.maxFeePerGas != null)
                    .map((x) => (0, viem_1.fromHex)(x.maxFeePerGas, "bigint")));
                const maxPriorityFeePerGas = (0, index_js_1.bigIntMax)(...requests
        ...
        Object.defineProperty(this, "_runMiddlewareStack", {
            ...
            value: async (uo, overrides) => {
                const result = await (0, index_js_1.asyncPipe)(this.dummyPaymasterDataMiddleware, this.feeDataGetter, this.gasEstimator, async (struct) => ({ ...struct, ...overrides }), this.customMiddleware, overrides?.paymasterAndData
                    ? exports.noOpMiddleware
                    : this.paymasterDataMiddleware, this.simulateUOMiddleware)(uo);
        ...
        Object.defineProperty(this, "feeDataGetter", {
            ...
            value: async (struct) => {
                ...
                const maxPriorityFeePerGasBid = (0, index_js_1.bigIntMax)((0, index_js_1.bigIntPercent)(maxPriorityFeePerGas, BigInt(100 + this.maxPriorityFeePerGasEstimateBuffer)), this.minPriorityFeePerBid);
