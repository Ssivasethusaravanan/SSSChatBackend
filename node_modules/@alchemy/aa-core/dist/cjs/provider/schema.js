...
exports.createSmartAccountProviderConfigSchema = exports.SmartAccountProviderOptsSchema = void 0;
const zod_1 = require("abitype/zod");
const zod_2 = __importDefault(require("zod"));
const schema_js_1 = require("../client/schema.js");
const index_js_1 = require("../utils/index.js");
exports.SmartAccountProviderOptsSchema = zod_2.default.object({
    ...
    minPriorityFeePerBid: zod_2.default.bigint().min(0n).optional(),
    maxPriorityFeePerGasEstimateBuffer: zod_2.default.number().min(0).optional(),
});
